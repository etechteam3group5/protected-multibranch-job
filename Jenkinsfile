pipeline{
	...
	stages{
        stage('Clone Repository'){
					steps{
						checkout([$class: 'GitSCM', branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'github-id', url: 'https://github.com/etechteam3group5/https://github.com/etechteam3group5/protected-multibranch-job.git.git']]])
					}
				}
